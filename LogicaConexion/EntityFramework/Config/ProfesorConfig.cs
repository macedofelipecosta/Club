...
{
    internal class ProfesorConfig:IEntityTypeConfiguration<Profesor>
    {
        public void Configure(EntityTypeBuilder<Profesor> builder)
        {
            ...
            builder.OwnsOne(profesor => profesor.Profesion).Property(profesion => profesion.Data).HasColumnName("Profesion");
        }
    }
}
